...
//         "http://localhost:3002/user/generate-otp-password",
//         {
//           email: email,
//         }
//       );
...
//       setLoading(true);
//       const response = await axios.post(
//         "http://localhost:3002/user/verify-otp-password",
//         {
//           email: email,
//           otp:otp
//         }
...
//         "http://localhost:3002/user/reset-password",
//         {
//           email: email,
//           otp:otp,
//           password
...
//         toast({
//           title: "Success",
//           description: `Successfully Password Chnaged`,
//           status: "success",
//           duration: 4000,
//           isClosable: true,
//         });
...
//   borderWidth={2}
//   borderColor={verified ? '#4CAF50' : (colorMode === 'light' ? '#005891' : '#121212')}
//   bg={verified ? 'transparent' : (colorMode === 'light' ? '#005891' : '#121212')}
//   color={verified ? '#4CAF50' : (colorMode === 'light' ? '#EDF2F7' : '#fff')}
//   _hover={{
//     bg: verified ? 'transparent' : (colorMode === 'light' ? '#004266' : '#101010'),
//     color: verified ? '#4CAF50' : (colorMode === 'light' ? '#EDF2F7' : '#fff'),
//   }}
//   size="md"
//   w="max-content"
...
// >
//   {loading ? <Spinner size="md" /> : (verified ? 'verified' : 'verify')}
// </Button>
//             </HStack>
//           </FormControl>
//           <Text
